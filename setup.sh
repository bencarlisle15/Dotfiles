...
LINE=$((LINE+1));sudo cp ~/Dotfiles/i3xrocks/config ~/.config/regolith/i3xrocks/conf.d/02_main || { echo $LINE ; exit 1; };
LINE=$((LINE+1));sudo cp ~/Dotfiles/i3extras/focused-window-name /usr/share/i3xrocks/focused-window-name2 || { echo $LINE ; exit 1; };
LINE=$((LINE+1));rm ~/.config/regolith/i3xrocks/conf.d/80_rofication || { echo $LINE ; exit 1; };
