...
LINE=$((LINE+1));git clone https://github.com/regolith-linux/regolith-i3xrocks-config.git || { echo $LINE ; exit 1; };
...
LINE=$((LINE+1));sudo mv ~/regolith-i3xrocks-config/scripts/* /usr/share/i3xrocks/ || { echo $LINE ; exit 1; };
LINE=$((LINE+1));rm -rf ~/regolith-i3xrocks-config || { echo $LINE ; exit 1; };
